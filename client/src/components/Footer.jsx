...
const Footer = () => {
  return (
    <footer class="bg-slate-100   my-14 ">
      <div class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
        <div>
          <h1 className="mt-1 text-lg font-bold text-black ">Contact us :</h1>
          <div className="flex gap-2 mt-2">
            <FaPhoneVolume className="text-green-700 mt-2" />
            <h2 className="mt-1 text-sm  font-medium text-black">
              {" "}
        ...
        <span class="text-sm md:mt-0 text-black sm:text-center ">
          © 2024{" "}
