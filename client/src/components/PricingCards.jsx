...
const PricingCards = () => {
  return (
    <section class="bg-white my-14 md:my-5">
      ...
      <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
        <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-slate-200  hover:border-black  rounded-lg border border-gray-100 shadow ">
          <h3
        ...
        <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 rounded-lg border bg-slate-200  hover:border-black border-gray-100 shadow ">
